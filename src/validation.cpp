...
// ---- PoA helpers (NEW) ------------------------------------------------------
static inline bool IsPoAActiveAtHeight(int height, const Consensus::Params& params) {
    return params.poa.IsActiveAt(height);
}

// Thin wrapper to your PoA QC implementation (src/poa/verify.{h,cpp})
static bool CheckQuorumCertificate(const CBlockHeader& header,
                                   const Consensus::Params& params,
                                   int nHeight,
                                   CValidationState& state) {
    return PoA::CheckQuorumCertificate(header, params, nHeight, state);
}
// -----------------------------------------------------------------------------
